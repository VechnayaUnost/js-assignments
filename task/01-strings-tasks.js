...
function getRectangleString(width, height) {
    ...
    upline = angle1 + upline + angle2 + "\n";
    dowline = angle3 + dowline + angle4;
    midline = v_line + midline + v_line;
    for (var j=0; j< height-2; j++)
    {
        upline = upline + midline + "\n";
    }
    return upline + dowline + "\n";
}
